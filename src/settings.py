...
DUMMY_FN_TEMPLATE_PATH = os.environ.get("DUMMY_FN_TEMPLATE_PATH", "dummy_function_generate.j2")
...
DUMMY_FUNCTIONS_PATH = os.environ.get("DUMMY_FUNCTIONS_PATH", os.path.join(RESULT_DIR, "dummy_functions.py"))