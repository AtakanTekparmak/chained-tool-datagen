...
help:
	...
	@echo ""
	@echo "Targets:"
	@echo "  1. data_genie_agents_setup  Clone the data-genie-agents repository and install its dependencies (should be run first)"
...
copy_env:
	if [ ! -f $(FILE) ]; then cp .env.example $(FILE); fi
